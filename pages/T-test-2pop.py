...
if not data_list1 or not data_list2:
    ...
    st.write('## Perform Two-Sample T-Test')
    ...
    t_stat, p_value = ttest_ind(df1['Data'], df2['Data'])
    ...
    if clicked:
        ...
        margin_error1 = alpha_t * (sample_std1 / math.sqrt(sample_size1))
        ...
        margin_error2 = alpha_t * (sample_std2 / math.sqrt(sample_size2))
